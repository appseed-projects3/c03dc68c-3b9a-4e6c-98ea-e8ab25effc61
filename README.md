...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-15 16:13`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c03dc68c-3b9a-4e6c-98ea-e8ab25effc61.git
$ cd c03dc68c-3b9a-4e6c-98ea-e8ab25effc61
```
